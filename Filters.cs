...
namespace ComputerGraphics_Filters
{
    ...
    {
        protected abstract Color newPixelColor(Bitmap sourceImage, int x, int y);
        ...
        public virtual Bitmap processImage(Bitmap sourceImage, BackgroundWorker worker,int MaxPercent = 100, int add = 0)
        {
            ...
            for (int i = 0; i < sourceImage.Width; i++)
            {
                ...
                {
                    resultImage.SetPixel(i, j, newPixelColor(sourceImage, i, j));
                }
            }
    ...
    {
        protected override Color newPixelColor(Bitmap sourceImage, int x, int y)
        {
